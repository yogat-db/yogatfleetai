...
const styles: Record<string, React.CSSProperties> = {
  ...
  sidebarWrapper: { transition: 'transform 0.25s ease', boxShadow: '2px 0 15px rgba(0,0,0,0.2)', zIndex: 100, width: '280px', background: theme.colors.background.card, height: '100%' },
